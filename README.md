...
|:---:|:---:|:---|
|Temp|Heat, Cold|High temp increases damage dealt and taken.Low temp increases health given and taken. Works as a resource and stat meter. For every 36 ticks of damage dealt, deal (heat). For every 36 ticks of damage taken, block equal to (cold). Heat and cold are two different resources that start at zero. Changes in pure temp, the stat, will change both in the same way.|
